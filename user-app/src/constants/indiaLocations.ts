/**
 * States/UTs and their districts, for the State/District dropdowns on Worker/Business
 * address forms (see AddressPicker) — replaces free-text entry for these two fields
 * specifically (City stays free text, since town/village names aren't a fixed list).
 * Snapshot as of early 2025; Indian district boundaries are revised periodically by state
 * governments (splits, renames) — re-verify against an authoritative source (e.g. the
 * Ministry of Panchayati Raj's Local Government Directory) before relying on this for
 * anything beyond a form picklist.
 */
...
export const INDIA_DISTRICTS_BY_STATE: Record<string, string[]> = {
  ...
  'Madhya Pradesh': [
    ...
    'Khandwa', 'Khargone', 'Maihar', 'Mandla', 'Mandsaur', 'Morena', 'Narmadapuram',
  ...
  Punjab: [
    ...
    'Moga', 'Mohali', 'Muktsar', 'Pathankot', 'Patiala', 'Rupnagar',
