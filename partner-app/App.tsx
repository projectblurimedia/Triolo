...
export default function App() {
  ...
  // Same wiring as user-app's own App.tsx — see that file's doc comment for the full
  // rationale; no shared package between the two apps, so keep both in sync by hand.
