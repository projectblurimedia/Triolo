...
/** Same registration fields/flow as user-app's — same account model, same backend. No inline language switcher here (unlike user-app) — kept minimal for this app's first pass. */
